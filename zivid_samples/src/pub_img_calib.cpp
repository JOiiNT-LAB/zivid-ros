...
bool callback_zivid_pub_img(std_srvs::SetBool::Request  &req, std_srvs::SetBool::Response &res)
{
  if(req.data)
  {
    ...
    file.request.file_path = ros::package::getPath("zivid_samples") + "/test0_6sec.yml";;
...
int main(int argc, char** argv)
{
  ...
  auto image_color_sub = n.subscribe("/zivid_camera/color/image_color_rect", 1, on_image_color);
